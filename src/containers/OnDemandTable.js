              ...
              <Tr key={`${index}`}>
                ...
                <Td minWidth={100}>
                  <Badge
                    cursor="pointer"
                    colorScheme="purple"
                    onClick={() => viewJson("ondemand", item?.id)}
                  >
                    View
                  </Badge>
                </Td>
